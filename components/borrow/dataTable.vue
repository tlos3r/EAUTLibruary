...
const deleteBorrow = async () => {
    ...
    refreshNuxtData("borrowDashboard");
};
</script>
...
<template>
    <div class="flex items-center py-4 space-x-4">
        <Button class="bg-blue-600 hover:bg-blue-500"
            ><NuxtLink to="/admin/dashboard/borrow/create" class="inline-flex items-center space-x-3">
        ...
        <Button :disabled="table.getFilteredSelectedRowModel().rows.length == 0" variant="destructive"
            ><NuxtLink class="inline-flex items-center space-x-3" @click="deleteBorrow">
